import { Box, Container, Step, Stepper, Button, StepButton } from "@mui/material";
...
const IntroContainer = () => {
    ...
    const ChallengeIntro = [
        {
            image: stepImg1,
            text: ["챌린지 탭에서 완독에 도전하고 싶은 챌린지를 선정합니다." ,
                    "도서 카테고리별, 그리고 도서명과 저자명으로 챌린지에 등록된 도서를 검색할 수 있습니다."],
            seq: "STEP1",
        ...
        {
            image: stepImg2,
            text: ["채키 타이머를 사용하여 하루 할당량을 설정합니다.",
                    "목표 시간을 채우면, 채키 투데이 작성란으로 이동할 수 있습니다.",
                    "타이머는 무제한으로 사용하실 수 있으며, 채키 투데이 작성은 하루에 한 번만 가능합니다."],
            seq: "STEP3",
            title: "채키 타이머 설정"
        },
        {
            image: stepImg2,
            text: ["오늘 읽은 페이지 수와 오늘의 감상평을 작성합니다.",
                    "마음에 드는 구절, 토의할 주제 등 감상평은 자유롭게 작성할 수 있으며, 이는 다른 사용자들과 함께 공유됩니다."],
            seq: "STEP4",
            title: "채키 투데이 작성"
        },
        {
            ...
            case 0:
                return (
                    <Box sx={{display:"flex", flexDirection:"column", alignItems:"center"}}>
                        ...
                        <Stepper nonLinear activeStep={activeStep} alternativeLabel sx={{pt:2}}>
